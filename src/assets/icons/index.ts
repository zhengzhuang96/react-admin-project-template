 ...
 * @LastEditTime: 2022-08-11 10:20:03
 * @Description: 
 */
...
import { ReactComponent as settings } from './black/settings.svg'
...
// 图标名称类型
const blackIconNames = tupleStr('menuArticle', 'menuBlank', 'menuChart', 'menuForm', 'menuHome', 'menuUser', 'settings')
